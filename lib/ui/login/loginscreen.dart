...
import 'package:riddhi_sample/ui/login/loginviewModel.dart';
import 'package:riddhi_sample/ui/register/registerscreen.dart';
...
class _LoginScreenState extends State<LoginScreen> {
  ...
  final passwordInput = TextField(
      onChanged: (text) => {pasw = text}, decoration: InputDecoration(hintText: 'Password'), obscureText: true, style: textStyle);
